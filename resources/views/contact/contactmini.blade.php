  ...
  <div class="main-color">
        ...
        <h4 class="shadow_text">{{_('Contact Us!')}}'</h4>
        <hr>
        <form id="contact_form_mini" action={{ url('/contact/store')  }} method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-group row">
            <div class="col">
              <label for="name" class="shadow_text col-sm-4 col-form-label text-md-right"><strong>{{ __('Name:') }}</strong></label><br>
          ...
          <div class="form-group row">
            <div class="col">
              <label for="email" class="shadow_text col-sm-4 col-form-label text-md-right"><strong>{{ __('Email:') }}</strong></label><br>
          ...
          <div class="form-group row">
            <div class="col">
              <label for="phone" class="shadow_text col-sm-4 col-form-label text-md-right"><strong>{{ __('Phone:') }}</strong></label><br>
          ...
          <div class="form-group row">
            <div class="col">
              <label for="notes" class="shadow_text col-sm-4 col-form-label text-md-right"><strong>{{ __('Message:') }}</strong></label><br>
