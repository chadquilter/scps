<div class="card">
  ...
  <div class="card-body shadow_only">
    ...
    <div class="card scidepartmentDiv">
      ...
      <div class="card-body">
        <p>
          {{ __('This course is for any student considering a career in medicine, science, engineering or higher-level mathematics. This class will provide an in-depth coverage of the basic topics of chemistry and is designed for those students with a strong mathematics background and the ability to understand and apply difficult theoretical concepts.')}}
        </p>
      </div>
    </div>
    <br>
    ...
    <div class="card scidepartmentDiv">
      ...
      <div class="card-body">
        <p>
          {{ __('AP Chemistry is a rigorous course which covers first-year college inorganic chemistry. Semester one course content includes: Atoms, Ions, Nomenclature, Stoichiometry, Qualitative and Quantitative Chemistry, Gases, Thermodynamics, Atomic Structure & Periodicity, Bonding, and Phases of Matter. Semester two content consists of: Properties of Solution, Chemical Kinetics, Chemical Equilibria, Acids & Bases, Electrochemistry, Nuclear Chemistry, and an Introduction to Organic Chemistry.')}}
        </p>
      </div>
    </div>
    <br>
    ...
    <div class="card scidepartmentDiv">
      ...
      <div class="card-body">
        <p>
          {{ __('This course is an algebra-based college-level course in general physics with topics ranging from Newtonian mechanics at the macro level to atomic physics. Students enrolled in this class should remember basic physics principles from previous science class. Students will develop intuition, creativity, and investigative skills in the field of science. This includes laboratory skills such as constructing apparatus, gathering and analyzing data, forming conclusions, and communicating results.')}}
        </p>
      </div>
    </div>
    <br>
...
<script>
$(".scidepartmentDiv").hide();
$(".subdept-button").click(function() {
  $(this).next(".scidepartmentDiv").toggle();
});
</script>
