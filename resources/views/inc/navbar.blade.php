        ...
        <div class="col col-auto float-sm-right">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-item {{ ( \config('app.locale') == 'en' ) ? 'active' : '' }}"><a href="/locale/en">English</a></li>
              <li class="dropdown-item {{ ( \config('app.locale') == 'zh' ) ? 'active' : '' }} ?"><a href="/locale/zh">简体中文 Chinese (Simplified)</a></li>
            </ul>
          </div>
