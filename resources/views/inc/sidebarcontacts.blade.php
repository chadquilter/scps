  ...
  <div class="col">
    ...
    <div class="card">
      <div class="card-body shadow_only">
        ...
        <p><strong>{{__('General Informations:')}}</strong><small><a href="mailto:general-info@spacecityschool.com">general-info@spacecityschool.com</a></small></p>
        <p><strong>{{__('Admissions:')}}</strong><small><a href="mailto:admissions@spacecityschool.com">admissions@spacecityschool.com</a></small></p>
        <p><strong>{{__('Job Opportunities:')}}</strong><small><a href="mailto:jobs@spacecityschool.com">jobs@spacecityschool.com</a></small></p>
        <p><strong>{{__('Media & Marketing:')}}</strong><small><a href="mailto:media-marketing@spacecityschool.com">media-marketing@spacecityschool.com</small></a></p>
        <hr class="lead">
      </div>
    </div>
  </div>
